...
//                .clickOnStageHistoryField("Insurance Stage",HistoryFileds)  ;
	...
	public void evaluationFilterTest() {
		stagesActions.navtoStages().clickOnStageHistoryField(stageName, evaluationFilter);
		stagesActions.evaluationFilter(sectionBCheckBoxes, stageName);
	}

	@Test
	public void SOPTest() {
		stagesActions.navtoStages().clickOnStageHistoryField("Insurance Stage", SOP).Sop();
	}

	@Test
	public void SOPDeleteTest() {
		stagesActions.navtoStages().clickOnStageHistoryField("Insurance Stage", SOP)
				.SOPDelete("Newsletter_AKpfiCE.pdf");
	}

	@Test
	public void reportFields() {
		stagesActions.navtoStages().clickOnStageHistoryField("Insurance Stage", reportFields).reportFields();
	}
...
//                .clickOnStageHistoryField("Insurance Stage",stageProcessfield)
	...
	public void reportFiltersTest() {
		stagesActions.navtoStages().clickOnStageHistoryField("Insurance Stage", reportFilters).reportFilters();

	}

	@Test
	public void dispositionTest() {
		stagesActions.navtoStages().clickOnStageHistoryField("Insurance Stage", Disposition).disposition();
	}
