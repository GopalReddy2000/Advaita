...
public class ScreenRecorderUtil extends ScreenRecorder {
    ...
    public String name;
    private static File currentRecording;
    ...
    protected File createMovieFile(Format fileFormat) throws IOException {
        ...
        File newFile = new File(movieFolder,
    ...
    public static void stopRecord() throws Exception {
        ...
        if (currentRecording != null && currentRecording.exists()) {
            System.out.println("Recording saved: " + currentRecording.getAbsolutePath());
        } else {
...
//	##### Usage #####
//	Add Below method in @BeforeTest Method
//	ScreenRecorderUtil.startRecord("ProcessRecording");
	
	
//	Add Below method in @AfterTest Method
