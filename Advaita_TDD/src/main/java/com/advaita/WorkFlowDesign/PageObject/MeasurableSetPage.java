...
public class MeasurableSetPage extends TestBase {
	...
	@FindBy(xpath = "//span[contains(text(),'Measurable Set has been created successfully')]/..//button[contains(text(),'Continue')]")
	...
	@FindBy(xpath = "//span[normalize-space(text())='Measurable Set has been updated successfully']")
	...
	public void createMeasurableSet(int count) throws Throwable {

		assertTrue(masterParaMeterTab.isDisplayed(), "masterParaMeterTab is not displayed.");
		assertTrue(measurableSetTab.isDisplayed(), "measurableSetTab is not displayed.");
