...
public class NonMeasurableSetPage extends TestBase {
	...
	@FindBy(xpath = "//span[contains(text(),'Non Measurable Set has been created successfully')]/..//button[contains(text(),'Continue')]")
	...
	@FindBy(xpath = "//span[normalize-space(text())='Non Measurable Set has been updated successfully']/..//button[normalize-space(text())='Continue']")
